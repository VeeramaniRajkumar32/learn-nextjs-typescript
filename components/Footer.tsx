            ...
            <div className="flex flex-col">
                ...
                <div className="flex flex-col mt-4 md:mt-0 md:flex-row">
                    <nav className="flex flex-col items-center justify-center flex-1 border-gray-100 md:items-end md:border-r md:pr-5">
                        ...
                        <Link aria-current="page" href={`/contactus`} className="hover:text-gray-700 dark:hover:text-white">
                            Contacts
                        </Link>
                        <a aria-current="page" href="#" className="hover:text-gray-700 dark:hover:text-white">
                            Customization
                    ...
                    <div className="flex items-center justify-center flex-1 mt-4 border-gray-100 md:mt-0 md:border-r">
                        ...
                        <a className="ml-4 hover:text-primary-gray-20" href="#">
                            ...
                            <svg width="30" height="30" fill="currentColor" className="text-xl transition-colors duration-200 hover:text-gray-800 dark:hover:text-white" viewBox="0 0 2048 1792" xmlns="http://www.w3.org/2000/svg">
